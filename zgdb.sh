...
./build/ALPHA_MESI_CMP_directory/gem5.opt  -debug-flag=InOrderTLB,TLB -d tests/test1/sjeng configs/spec2k6_classic/run.py --cpu-type=inorder --caches -b sjeng --maxinsts=1000000000
