...
gdb --args ./build/ALPHA_MESI_CMP_directory/gem5.opt ${DEBUG_FLAG} -d tests/test1/sjeng configs/spec2k6_classic/run.py --cpu-type=inorder --caches -b sjeng --maxinsts=2
